package com.lorrdi.digitcomponents.presentation.viewmodels
...
import com.lorrdi.digitcomponents.data.GameRepositoryImpl
...
import com.lorrdi.digitcomponents.domain.usecases.GenerateQuestionUseCase
import com.lorrdi.digitcomponents.domain.usecases.GetGameSettingUseCase
...
class GameViewModel(private val level: Level, private val application: Application) : ViewModel() {
    ...
    private val getGameSettingUseCase: GetGameSettingUseCase = GetGameSettingUseCase(repository)
    ...
    private fun getGameSettingForLevel() {
